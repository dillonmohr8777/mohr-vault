# Shadow HVAC — Optimization Ledger
...
what failed and lean into what worked for Shadow HVAC specifically. Append only. Managed by `campaign-intel`.
...
```jsonl
{"date":"","client":"Shadow HVAC","account":"","change":"","hypothesis":"","expected":"","tier":1,"review_on":"","verdict":null,"measured_delta":null}
```
