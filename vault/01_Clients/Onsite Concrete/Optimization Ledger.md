# Onsite Concrete — Optimization Ledger
...
what failed and lean into what worked for Onsite Concrete specifically. Append only. Managed by `campaign-intel`.
...
```jsonl
{"date":"","client":"Onsite Concrete","account":"","change":"","hypothesis":"","expected":"","tier":1,"review_on":"","verdict":null,"measured_delta":null}
```
