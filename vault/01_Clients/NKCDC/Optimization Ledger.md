...
what failed and lean into what worked for NKCDC specifically. Append only. Managed by `campaign-intel`.
...
```jsonl
{"date":"","client":"NKCDC","account":"","change":"","hypothesis":"","expected":"","tier":1,"review_on":"","verdict":null,"measured_delta":null}
```
