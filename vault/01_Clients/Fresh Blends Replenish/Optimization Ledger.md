# Fresh Blends Replenish — Optimization Ledger
...
what failed and lean into what worked for Fresh Blends Replenish specifically. Append only. Managed by `campaign-intel`.
...
```jsonl
{"date":"","client":"Fresh Blends Replenish","account":"","change":"","hypothesis":"","expected":"","tier":1,"review_on":"","verdict":null,"measured_delta":null}
```
